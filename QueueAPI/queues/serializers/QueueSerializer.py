...
class QueueSerializer(serializers.Serializer):
    ...
    queue_code = serializers.CharField(max_length=50)
    applicant_name = serializers.CharField(max_length=50, required=True)
    no_applicant = serializers.IntegerField(required=False)
    applicant_type = serializers.CharField(max_length=50, required=False)
    is_senior_pwd  = serializers.BooleanField(required=True)
    queue_no = serializers.IntegerField()
    coordinator_name = serializers.CharField(max_length=100, required=False)
    ...
    is_called = serializers.BooleanField(required=True)
    is_priority = serializers.BooleanField(required=True)
