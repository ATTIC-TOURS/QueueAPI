...
main_office_services = [
    ...
    },
    {
        "name": "Claim Passport", 
        "branch_id": MAIN_OFFICE_ID, 
        "category_id": PASSPORT_MAIN_OFFICE_ID, 
    },
    {
    ...
    },
    {
        "name": "Tour Package", 
        "branch_id": MAIN_OFFICE_ID, 
        "category_id": TOUR_PACKAGE_MAIN_OFFICE_ID, 
    },
    {
        "name": "China Visa", 
        "branch_id": MAIN_OFFICE_ID, 
        "category_id": OTHER_VISA_MAIN_OFFICE_ID, 
    },
    {
        "name": "Data Sim Card", 
        "branch_id": MAIN_OFFICE_ID, 
        "category_id": OTHER_SERVICES_MAIN_OFFICE_ID, 
    },
    {
        "name": "JR Pass", 
        "branch_id": MAIN_OFFICE_ID, 
...
def create_default_services(apps, schema_editor):
    ...
    for service in services:
        Service.objects.create(
            ...
            is_cut_off=service.get("cut-off", False),
